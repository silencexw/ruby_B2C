...
Rails.application.config.sorcery.configure do |config|
  ...
  # Set token randomness. (e.g. users activation tokens)
  ...
  # Linkedin requires r_emailaddress scope to fetch users's email address.
  ...
  config.user_config do |user|
    ...
    # Default: `true`
    #
    # users.magic_login_mailer_disabled =

    # How many seconds before the request expires. nil for never expires.
    # Default: `nil`
    #
    # users.magic_login_expiration_period =

    # Hammering protection: how long in seconds to wait before allowing another email to be sent.
    # Default: `5 * 60`
    #
    # users.magic_login_time_between_emails =
    ...
    # How long since users's last activity will they be considered logged out?
    # Default: `10 * 60`
    #
